...
/* Hide Streamlit widget icons that overlap text */
...
if st.session_state.get("plan"):
    ...
    # Rainbow color cycle for study days
...
st.markdown('<div style="text-align:center;margin-top:2rem;color:#888;font-size:0.8rem;">Made with 🌈 for BTech &amp; Degree students</div>', unsafe_allow_html=True)